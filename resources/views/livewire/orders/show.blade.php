...
<div>
    ...
    <div class="grid gap-6 lg:grid-cols-3">
        ...
        <x-card title="Who did what" subtitle="Every step, attributed and timestamped" :flush="true">
            <div class="table-scroll">
                    ...
                    <tbody class="divide-y divide-slate-100 dark:divide-white/5">
                        ...
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-white/[0.02]">
                            <td class="px-3.5 py-2.5 align-top">
                                <x-badge class="bg-blue-50 text-blue-700 ring-blue-600/20 dark:bg-blue-500/10 dark:text-blue-400">Order Placed</x-badge>
                            </td>
                            <td class="px-3 py-2.5 align-top">
                                <div class="font-medium text-slate-900 dark:text-slate-100">{{ $order->orderedBy->full_name }}</div>
                                <div class="text-[11px] text-slate-500 dark:text-slate-400">{{ $order->orderedBy->designation }}</div>
                                @if ($order->expected_date)
                                    <div class="mt-0.5 text-[11px] text-slate-400 dark:text-slate-500">Expected {{ $order->expected_date->format('d M Y') }}</div>
                                @endif
                            </td>
                        ...
                        @if ($receipt)
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-white/[0.02]">
                                <td class="px-3.5 py-2.5 align-top">
                                    <x-badge class="bg-teal-50 text-teal-700 ring-teal-600/20 dark:bg-teal-500/10 dark:text-teal-400">Goods Verified</x-badge>
                                </td>
                                <td class="px-3 py-2.5 align-top">
                        ...
                        @else
                            <tr class="bg-amber-50/40 hover:bg-amber-50/60 dark:bg-amber-500/5 dark:hover:bg-amber-500/10">
                                <td class="px-3.5 py-2.5 align-top">
                                    <x-badge class="bg-amber-50 text-amber-700 ring-amber-600/20 dark:bg-amber-500/10 dark:text-amber-400">Awaiting Verification</x-badge>
                                </td>
                        ...
                        @if ($bill)
                            <tr class="hover:bg-slate-50/50 dark:hover:bg-white/[0.02]">
                                <td class="px-3.5 py-2.5 align-top">
                                    <x-badge class="bg-indigo-50 text-indigo-700 ring-indigo-600/20 dark:bg-indigo-500/10 dark:text-indigo-400">Bill {{ $bill->bill_no }}</x-badge>
                                </td>
                                <td class="px-3 py-2.5 align-top">
